...
#define AI_NETWORK_IN { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_U8, 1, 128, 128, 1, NULL), \
}
#define AI_NETWORK_IN_SIZE { \
  (1 * 128 * 128), \
}
#define AI_NETWORK_IN_1_SIZE  (1 * 128 * 128)
#define AI_NETWORK_IN_1_SIZE_BYTES  ((1 * 128 * 128) * 1)
...
#define AI_NETWORK_OUT { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_U8, 1, 1, 4, 1, NULL), \
}
#define AI_NETWORK_OUT_SIZE { \
  (1 * 1 * 4), \
}
#define AI_NETWORK_OUT_1_SIZE  (1 * 1 * 4)
#define AI_NETWORK_OUT_1_SIZE_BYTES  ((1 * 1 * 4) * 1)
